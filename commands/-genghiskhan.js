...
module.exports = {
  ...
  run: function (client, message, args) {
        ...
        const displayInformacoes = {
            ...
            autor : "Pedro",
            Informacoes : {
                displayAvatarURL : "https://bit.ly/2LyFZyH",
                displayImgTalento : "https://i.imgur.com/dpYHpkC.png",
                nome : 'Genghis Khan',
                tipo : 'Lendário',
                especialidade : 'Cavalaria, Versalidade, Habilidade.',
                poder : '1.200'
            },
        }
  ...
  get help () {
    return {
      name: 'genghiskhan',
      description: 'Mostra todos os atributos do comandante Genghis Khan.',
      usage: 'genghiskhan',
