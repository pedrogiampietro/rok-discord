...
module.exports = {
  ...
  run: function (client, message, args) {
    ...
    const displayInformacoes = {
            ...
            autor : "Pedro",
            Informacoes : {
                displayAvatarURL : "https://bit.ly/2WUAnUY",
                displayImgTalento : "https://i.imgur.com/9x2zOKB.png",
                nome : 'Constantine I',
                tipo : 'Lendário',
                especialidade : 'Infantaria, Guarnição, Suporte.',
                poder : '1.200'
            },
        }
  ...
  get help () {
    return {
      name: 'constantine',
      description: 'Mostra todos os atributos do comandante Constantine I.',
      usage: 'constantine',
