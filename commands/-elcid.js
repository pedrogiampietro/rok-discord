...
module.exports = {
  ...
  run: function (client, message, args) {
    ...
    const displayInformacoes = {
            ...
            autor : "Pedro",
            Informacoes : {
                displayAvatarURL : "https://bit.ly/3bteuB7",
                displayImgTalento : "https://i.imgur.com/0Cysh5E.png",
                nome : 'El Cid',
                tipo : 'Lendário',
                especialidade : 'Arqueiro, Versalidade, Habilidade.',
                poder : '1.000'
            },
        }
  ...
  get help () {
    return {
      name: 'elcid',
      description: 'Mostra todos os atributos do comandante El Cid.',
      usage: 'elcid',
