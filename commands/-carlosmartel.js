...
module.exports = {
  ...
  run: function (client, message, args) {
    ...
    const displayInformacoes = {
            ...
            autor : "Pedro",
            Informacoes : {
                displayAvatarURL : "https://bit.ly/3dNwE2g",
                displayImgTalento : "https://i.imgur.com/Lb5Ahb8.png",
                nome : 'Charles Martel',
                tipo : 'Lendário',
                especialidade : 'Infantaria, Guarnição, Defesa.',
                poder : '1.000'
            },
        }
  ...
  get help () {
    return {
      name: 'carlosmartel',
      description: 'Mostra todos os atributos do comandante Carlos Martel.',
      usage: 'carlosmartel',
