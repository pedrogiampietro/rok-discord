...
module.exports = {
  ...
  run: function (client, message, args) {
        ...
        const displayInformacoes = {
            ...
            autor : "Pedro",
            Informacoes : {
                displayAvatarURL : "https://bit.ly/2ZcFMJA",
                displayImgTalento : "https://i.imgur.com/M3uBGIG.png",
                nome : 'Hannibal Barca',
                tipo : 'Lendário',
                especialidade : 'Líder, Conquistador, Ataque.',
                poder : '1.100'
            },
        }
  ...
  get help () {
    return {
      name: 'hannibalbarca',
      description: 'Mostra todos os atributos do comandante Hannibal Barca.',
      usage: 'hannibalbarca',
