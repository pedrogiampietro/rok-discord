...
module.exports = {
  ...
  run: function (client, message, args) {
    ...
    const displayInformacoes = {
            ...
            autor : "Pedro",
            Informacoes : {
                displayAvatarURL : "https://bit.ly/3cD3fHO",
                displayImgTalento : "https://i.imgur.com/xO5PgRH.png",
                nome : 'Cleopatra VII',
                tipo : 'Lendário',
                especialidade : 'Integração, Coleta, Suporte.',
                poder : '800'
            },
        }
  ...
  get help () {
    return {
      name: 'cleopatra',
      description: 'Mostra todos os atributos do comandante Cleopatra VII.',
      usage: 'cleopatra',
