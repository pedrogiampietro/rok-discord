...
module.exports = {
  ...
  run: function (client, message, args) {
    ...
    const displayInformacoes = {
            ...
            autor : "Pedro",
            Informacoes : {
                displayAvatarURL : "https://bit.ly/365XoYZ",
                displayImgTalento : "https://rok.guide/wp-content/uploads/2019/09/mehmed-ii-pvp-buildings-build.jpg",
                nome : 'Mehmed II',
                tipo : 'Lendário',
  ...
  get help () {
    return {
      name: 'mehmedii',
      description: 'Mostra todos os atributos do comandante Mehmed II.',
      usage: 'mehmedii',
