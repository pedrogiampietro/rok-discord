...
module.exports = {
  ...
  run: function (client, message, args) {
    ...
    const displayInformacoes = {
            ...
            autor : "Pedro",
            Informacoes : {
                displayAvatarURL : "https://bit.ly/3cAUvBZ",
                displayImgTalento : "https://i.imgur.com/uaYCHab.png",
                nome : 'Cao Cao',
                tipo : 'Lendário',
                especialidade : 'Cavaleria, Manutenção da Paz, Mobilidade.',
                poder : '1.100'
            },
        }
  ...
  get help () {
    return {
      name: 'caocao',
      description: 'Mostra todos os atributos do comandante Cao Cao.',
      usage: 'caocao',
